...
// in simulator we redefine to format for RTDNext Developer console
...
{\
	NSString * exceptionName = [@"org.rtdnext." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rtdnext";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRTDNextNativeItemNone = -1, 
	UIRTDNextNativeItemSpinner = -2,
	UIRTDNextNativeItemProgressBar = -3,
	
	UIRTDNextNativeItemSlider = -4,
	UIRTDNextNativeItemSwitch = -5,
	UIRTDNextNativeItemMultiButton = -6,
	UIRTDNextNativeItemSegmented = -7,
	
	UIRTDNextNativeItemTextView = -8,
	UIRTDNextNativeItemTextField = -9,
	UIRTDNextNativeItemSearchBar = -10,
	
	UIRTDNextNativeItemPicker = -11,
	UIRTDNextNativeItemDatePicker = -12,
	
	UIRTDNextNativeItemInfoLight = -13,
	UIRTDNextNativeItemInfoDark = -14,
	
	UIRTDNextNativeItemDisclosure = -15,
	
	UIRTDNextNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RTDNext instances of
