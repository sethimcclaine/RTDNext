...
//@interface RTDNextObject : NSObject
//@end

@interface RTDNextObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RTDNextObject class]])
		{
			for (NSString *key in [[(RTDNextObject*)o modules] allKeys])
			{
